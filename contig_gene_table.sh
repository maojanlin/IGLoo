...
do
    #echo ${sample_id}
    python3 contig_gene_table.py -bed1 ../gAIRRsuite/hprc_annotation/${sample_id}/group_genes.1.bed \
                                 -bed2 ../gAIRRsuite/hprc_annotation/${sample_id}/group_genes.2.bed \
                                 -target materials/IGH_functional.txt \
                                 -out1 IGH_contig_new/${sample_id}.contig_gene.1.csv \
                                 -out2 IGH_contig_new/${sample_id}.contig_gene.2.csv \
                                 --summary_bk break_points_summary.rpt
